...
![This is the image for your viewing, although the link provided is broken](https://curiodyssey.org/wp-content/uploads/bb-plugin/cache/Mammals-Raccoon-square.jpg)
...
```
function test(){
  console.log("Raccoons are scary");
}
```